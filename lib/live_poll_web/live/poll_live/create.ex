defmodule LivePollWeb.PollLive.Create do
  ...
  def handle_event("create_product", %{"poll" => poll_params}, socket) do
    socket =
      case Context.create_poll(poll_params) do
        {:ok, %Polls{} = poll} -> put_flash(socket, :info, "Created poll!")
  ...
  def handle_event("validate_product", %{"poll" => poll_params}, socket) do
    form =
